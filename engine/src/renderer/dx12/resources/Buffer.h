...
public:
    ...
    bool Initialize(D3D12MA::Allocator* allocator, const void* data, UINT64 size, UINT stride, bool dynamic = false);
    ...
    // View creation (caller decides how to interpret the data)
